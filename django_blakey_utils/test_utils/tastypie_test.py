...
warnings.warn("This is a copy of tastypie.test module from master branch. It is not released yet. When it is released please change imports of tastypie_test to tastypie.test and delete this file", FutureWarning)
